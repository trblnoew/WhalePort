	...
	<section class="bg-primary-subtle custom-height">
		<div class="container-fluid">
			<div class="text-center">
				<p class="text-primary fs-4 fw-bolder">My Board</p>
				<h1 class="fw-bolder fs-12">나의 게시글</h1>
			</div>
		</div>
	</section>
</div>
...
<div align="center">
        ...
        <div align="right" style="width: 80%;">
         <a href="/customer/myPage" class="btn btn-outline-primary text-primary">이전</a>
        </div>
        <!-- Paging -->
